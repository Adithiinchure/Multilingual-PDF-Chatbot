...
# ============ ROBUST NLTK SETUP - FIXES BadZipFile ERROR ============
import nltk
import ssl
import warnings
...
# Graceful NLTK handling - continue even if punkt fails
try:
    ...
    try:
        ...
        pass  # Continue anyway - punkt not actually used
...
TOP_K_RETRIEVAL = 8
BM25_K = 12
VECTOR_K = 12  # FIXED: Lower to match actual index size
